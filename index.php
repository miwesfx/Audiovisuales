...
?>
  <h2>Herramienta de control de espacios audiovisuales</h2>
	...
	<table class="table table-hover">
		...
		foreach($centros as $centro)
			if($centro->id_campus==$campus->mostrar_id_campus())
				echo '<tr><td><a href="/audiovisuales/espacios.php?id_centro='.$centro->mostrar_id_centro().'&videoconferencia=any&tipo=any&aforo=any"><div>'.$centro->mostrar_nombre_centro().'</div></a></td></tr>';
		?>
		</tbody>
	</table>
	</div>
